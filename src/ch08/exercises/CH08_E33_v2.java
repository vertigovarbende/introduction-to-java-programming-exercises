...
public class CH08_E33_v2 { // Inner Triangles!
	...
	public static void calculateAllTrianglesAreas(double[][] points) {
		double[] intersectingPoint = getIntersectingPoint(points[1], points[3], points[0], points[2]);
		double[] allAreas = new double[ROW];

		allAreas[0] = getTriangleArea(points[0], points[1], intersectingPoint);
		allAreas[1] = getTriangleArea(points[1], points[2], intersectingPoint);
		allAreas[2] = getTriangleArea(points[2], points[3], intersectingPoint);
		allAreas[3] = getTriangleArea(points[0], points[3], intersectingPoint);
