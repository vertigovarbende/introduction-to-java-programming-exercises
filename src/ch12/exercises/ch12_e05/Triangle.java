...
public class Triangle extends GeometricObject {
	...
	public Triangle(double side1, double side2, double side3) throws RuntimeException, IllegalTriangleException {
		super();
		if (side1 <= 0 || side2 <= 0 || side3 <= 0)
			throw new RuntimeException("sides cannot equals to zero or any negative value!");
